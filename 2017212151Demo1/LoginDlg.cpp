...
BOOL CLoginDlg::OnInitDialog()
{
	...
	if (!mysql_real_connect(&m_mysql, "localhost", "root", "hellodsp", "school", 3306, NULL, 0))//连接MYSQL后台数据库
	{
...
void CLoginDlg::OnBnClickedOk()
{
	...
	m_edtUser.GetWindowText(str_user);
	m_edtPassword.GetWindowText(str_password);
	...
	else
	{
		...
		row = mysql_fetch_row(result); if (row == NULL)
		{
